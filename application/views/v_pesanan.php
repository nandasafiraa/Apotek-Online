  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h3>Terimakasih anda telah memesan obat-obat an kami</h3>
        <p>untuk melanjutkan pembelian, silahkan anda transfer sejumlah Rp. <span id="totalnya">0</span> ke rekening berikut: </p>
        <p>BANK BCA : 0987654345678</p>
        jika sudah transfer, silahkan upload bukti pembayaran transfer dibawah ini
